# ============================================================
# UNI-RGB-MLP — Official Test Evaluation Script (CLI)
# ============================================================
#
...
#
# Usage:
#   uv run python UNI-RGB-MLP/evaluate_uni_rgb_mlp.py \
#       --config configs/uni_rgb_mlp_config.yaml
# ============================================================
...
from train_uni_rgb_mlp import get_test_transform
...
def setup_logging(log_dir: str) -> logging.Logger:
    logger = logging.getLogger("uni_rgb_mlp_eval")
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Evaluate UNI-RGB-MLP on Official Test Set")
    parser.add_argument("--config", type=str, default="configs/uni_rgb_mlp_config.yaml")
...
def main() -> None:
    ...
    # Build the UNI-RGB-MLP and load best.pt.
    model = UNIRGBMLP(
    ...
    print("=" * 60)
    print("UNI-RGB-MLP — Official Test Evaluation")
    print("=" * 60)
    ...
    with open(report_path, "w") as f:
        f.write("=" * 60 + "\n")
        f.write("UNI-RGB-MLP — Official Test Evaluation\n")
        f.write("=" * 60 + "\n\n")
