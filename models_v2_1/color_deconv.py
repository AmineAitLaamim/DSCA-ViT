# ============================================================
# DSS-ViT — Color Deconvolution (self-contained copy)
# ============================================================
#
# This is a self-contained copy of the fixed Ruifrok & Johnston
# ColorDeconvolution from models_v2/color_deconv.py. It is
# physics-based (non-learnable) and identical to the original.
#
# The original models/, models_v2/, models_v3/ are NOT modified.
# ============================================================
