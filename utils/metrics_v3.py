...
# ============================================================
#
# Metrics for the v3 experiment:
#   accuracy, balanced accuracy, macro F1,
#   per-class precision/recall/F1, confusion matrix
#
# Used for validation monitoring (every epoch) and for the single
# final official-test evaluation.
#
# The original utils/metrics.py and utils/metrics_v2.py are NOT modified.
# ============================================================
...
def compute_metrics_v3(
    ...
    """
    Computes the full v3 metric set.
...
def print_metrics_v3(metrics: dict, title: str = "Metrics (v3)") -> None:
    """
    Pretty-print the v3 metric set.

    Args:
        metrics: The metric dict from compute_metrics_v3.
