...
#
# Usage:
#   python utils/evaluate_plain_vit_baseline.py --config configs/plain_vit_baseline_config.yaml
# ============================================================
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Path to the checkpoint. Defaults to <checkpoint_dir>/best_stage2.pt",
    )
