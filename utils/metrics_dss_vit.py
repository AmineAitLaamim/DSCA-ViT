# ============================================================
# DSS-ViT — Metrics Utilities
# ============================================================
#
# Provides accuracy, balanced accuracy, macro-F1, per-class
# precision/recall/F1, quadratic weighted kappa (QWK), and
...
def compute_metrics(
    ...
    Args:
        ...
        class_names (Optional[List[str]]): Class names for reporting.

    Returns:
        Dict: Dictionary of metrics including accuracy, balanced
              accuracy, macro-F1, per-class P/R/F1, QWK, and
              confusion matrix.
    """
