# ============================================================
# DSS-ViT v2.2 — Official Test Evaluation Script (CLI)
# ============================================================
#
...
#
# Usage:
#   python utils/evaluate_dss_vit_v2_2.py --config configs/dss_vit_v2_2_config.yaml
# ============================================================
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Evaluate DSS-ViT v2.2 on official test set")
    parser.add_argument(
        "--config",
        type=str,
...
def main() -> None:
    ...
    # ------------------------------------------------------------
    # Build model (v2.2: reduced capacity)
    # ------------------------------------------------------------
    model = DSSViT(
    ...
    with open(report_path, "w") as f:
        f.write("=" * 60 + "\n")
        f.write("DSS-ViT v2.2 Official Test Evaluation\n")
        f.write("=" * 60 + "\n\n")
