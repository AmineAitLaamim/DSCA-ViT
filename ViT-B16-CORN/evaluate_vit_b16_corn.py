# ============================================================
# ViT-B16-CORN — Official Test Evaluation Script (CLI)
# ============================================================
#
...
#
# Usage:
#   uv run python ViT-B16-CORN/evaluate_vit_b16_corn.py \
...
from train_vit_b16_corn import get_test_transform
...
def setup_logging(log_dir: str) -> logging.Logger:
    logger = logging.getLogger("vit_b16_corn_eval")
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Evaluate ViT-B16-CORN on Official Test Set")
...
def main() -> None:
    ...
    # Build the ViT-B16-CORN and load best_stage2.pt.
    model = ViTB16CORN(
    ...
    # Official test set — ImageNet-normalized transforms (dataloader).
    ...
    print("=" * 60)
    print("ViT-B16-CORN — Official Test Evaluation")
    print("=" * 60)
    ...
    with open(report_path, "w") as f:
        f.write("=" * 60 + "\n")
        f.write("ViT-B16-CORN — Official Test Evaluation\n")
        f.write("=" * 60 + "\n\n")
