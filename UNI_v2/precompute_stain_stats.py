# ============================================================
# UNI-Stain-MLP — Precompute Global Stain Statistics
# ============================================================
#
...
#
# Uses the SAME ColorDeconvolution implementation inside UNI_v2/
# (UNI_v2/color_deconv.py) so stain normalization is self-consistent.
#
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Precompute global H/DAB stain statistics (UNI-Stain-MLP)."
    )
    parser.add_argument(
        "--config",
        type=str,
        default="configs/uni_stain_mlp_config.yaml",
        help="Path to the UNI-Stain-MLP config file.",
    )
