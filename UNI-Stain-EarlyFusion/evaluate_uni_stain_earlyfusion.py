# ============================================================
# UNI-Stain-EarlyFusion — Official Test Evaluation Script (CLI)
# ============================================================
#
# Loads the best Stage 2 checkpoint (best_stage2.pt — NEVER
# last.pt) and evaluates on the official test set exactly once.
#
# Rebuilds the SAME 5-channel early-fusion projection (strict-load-
# before-replace), then loads the saved training checkpoint.
#
...
from train_uni_stain_earlyfusion import get_test_transform
...
def setup_logging(log_dir: str) -> logging.Logger:
    logger = logging.getLogger("uni_stain_earlyfusion_eval")
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Evaluate UNI-Stain-EarlyFusion on Official Test Set")
...
def main() -> None:
    ...
    # Build the UNI-Stain-EarlyFusion (reconstructed 5-channel projection)
    # and load best_stage2.pt.
    ...
    print("=" * 60)
    print("UNI-Stain-EarlyFusion — Official Test Evaluation")
    print("=" * 60)
    ...
    with open(report_path, "w") as f:
        f.write("=" * 60 + "\n")
        f.write("UNI-Stain-EarlyFusion — Official Test Evaluation\n")
        f.write("=" * 60 + "\n\n")
