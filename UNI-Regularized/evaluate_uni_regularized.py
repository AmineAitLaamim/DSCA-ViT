# ============================================================
# UNI-Regularized — Official Test Evaluation Script (CLI)
# ============================================================
#
...
from train_uni_regularized import get_test_transform
...
def setup_logging(log_dir):
    logger = logging.getLogger("uni_regularized_eval")
...
# ------------------------------------------------------------
def parse_args():
    parser = argparse.ArgumentParser(description="Evaluate UNI-Regularized on Official Test Set")
