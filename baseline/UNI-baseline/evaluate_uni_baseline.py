# ============================================================
# UNI Baseline — Official Test Evaluation Script (CLI)
# ============================================================
#
...
# QWK, per-class P/R/F1, and confusion matrix.
#
# Usage:
#   uv run python baseline/UNI-baseline/evaluate_uni_baseline.py \
...
from train_uni_baseline import get_test_transform
...
def setup_logging(log_dir: str) -> logging.Logger:
    logger = logging.getLogger("uni_baseline_eval")
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Evaluate UNI Baseline on Official Test Set")
...
def main() -> None:
    ...
    # Build the UNI baseline and load best_stage2.pt.
    ...
    print("=" * 60)
    print("UNI Baseline — Official Test Evaluation")
    print("=" * 60)
    ...
    with open(report_path, "w") as f:
        f.write("=" * 60 + "\n")
        f.write("UNI Baseline — Official Test Evaluation\n")
        f.write("=" * 60 + "\n\n")
