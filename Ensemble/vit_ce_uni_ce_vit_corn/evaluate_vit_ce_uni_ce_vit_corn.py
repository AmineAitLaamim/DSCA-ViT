# ============================================================
# Ensemble — Variant: ViT-B16 CE + UNI CE + ViT-B16 CORN (no TTA)
# ============================================================
#
...
#
# Only PROBS are used for ensembling — never raw logits. For CORN
# this means its chain-rule-reconstructed [B,4] probs (sums to 1),
# not the raw [B,3] conditional logits.
#
# Run by path:
...
VARIANT_NAME = "vit_ce_uni_ce_vit_corn"
EXPERIMENT_NAME = "vit_ce_uni_ce_vit_corn_001"
