# Ensemble — vit_ce_uni_ce_vit_corn_tta

**Equal-weight probability averaging of three complementary models with test-time augmentation (TTA).**
...
- ViT-B16 CE / ViT-B16 CORN: `Resize -> flip/rotate -> ToTensor -> Normalize(ImageNet)`
...
ensemble_probs = (probs_vit_tta + probs_uni_tta + probs_corn_tta) / 3
...
Artifacts:
```
logs/Ensemble/vit_ce_uni_ce_vit_corn_tta/vit_ce_uni_ce_vit_corn_tta_001/
results/Ensemble/vit_ce_uni_ce_vit_corn_tta/vit_ce_uni_ce_vit_corn_tta_001/{val,test}_results.{json,txt}
```
