# ============================================================
# DSS-ViT v2.2 — StainEncoder (reduced capacity)
# ============================================================
#
...
#   This reduces total params to ~3-4M (from ~8-9M).
#
...
#   Flatten                                     # [B,4096]
#   Linear(4096, 256) -> GELU                   # bottleneck 256
#   Linear(256, 8 * 768)                        # [B, 6144]
#   Reshape to [B, 8, 768]
#
...
class StainEncoder(nn.Module):
    ...
    Args:
        ...
        num_tokens (int): Number of output tokens (8 for v2.2).
        bottleneck_dim (int): Hidden bottleneck dimension (256 for v2.2).
