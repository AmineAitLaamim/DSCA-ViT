# ============================================================
# UNI-Stain-Attention — Color Deconvolution (self-contained copy)
# ============================================================
#
# Self-contained copy of the Ruifrok & Johnston ColorDeconvolution
# from UNI_v2/color_deconv.py (identical implementation).
#
...
#
# Existing packages (UNI_v2/, models_v2_2/, etc.) are NOT modified.
# ============================================================
