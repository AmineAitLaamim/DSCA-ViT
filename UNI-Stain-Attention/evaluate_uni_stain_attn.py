# ============================================================
# UNI-Stain-Attention — Official Test Evaluation Script (CLI)
# ============================================================
#
...
#
# Usage:
#   uv run python UNI-Stain-Attention/evaluate_uni_stain_attn.py \
...
from train_uni_stain_attn import get_test_transform
...
def setup_logging(log_dir: str) -> logging.Logger:
    logger = logging.getLogger("uni_stain_attn_eval")
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Evaluate UNI-Stain-Attention on Official Test Set")
...
def main() -> None:
    ...
    # Build the UNI-Stain-Attention and load best.pt.
    ...
    print("=" * 60)
    print("UNI-Stain-Attention — Official Test Evaluation")
    print("=" * 60)
    ...
    with open(report_path, "w") as f:
        f.write("=" * 60 + "\n")
        f.write("UNI-Stain-Attention — Official Test Evaluation\n")
        f.write("=" * 60 + "\n\n")
