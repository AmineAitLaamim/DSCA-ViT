# ============================================================
# UNI-Stain-Attention — Precompute Global Stain Statistics
# ============================================================
#
...
# UNI-Stain-Attention/ (UNI-Stain-Attention/color_deconv.py)
# so stain normalization is self-consistent.
#
# Runs on a single GPU or CPU only (NOT under DDP).
#
# Usage:
#   uv run python UNI-Stain-Attention/precompute_stain_stats.py \
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Precompute global H/DAB stain statistics (UNI-Stain-Attention)."
    )
    parser.add_argument(
        "--config",
        type=str,
        default="configs/uni_stain_attn_config.yaml",
        help="Path to the UNI-Stain-Attention config file.",
    )
