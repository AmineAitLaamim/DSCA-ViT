# ============================================================
# UNI-Regularized-v2 — Official Test Evaluation Script (CLI)
# ============================================================
#
...
#
# Usage:
#   uv run python UNI-Regularized/evaluate_uni_regularized.py \
...
from train_uni_regularized_v2 import get_test_transform
...
def setup_logging(log_dir):
    logger = logging.getLogger("uni_regularized_v2_eval")
...
# ------------------------------------------------------------
def parse_args():
    parser = argparse.ArgumentParser(description="Evaluate UNI-Regularized-v2 on Official Test Set")
...
def main():
    ...
    # Build the UNI-Regularized and load best_stage2.pt.
    ...
    print("=" * 60)
    print("UNI-Regularized — Official Test Evaluation")
    print("=" * 60)
    ...
    with open(report_path, "w") as f:
        f.write("=" * 60 + "\n")
        f.write("UNI-Regularized — Official Test Evaluation\n")
        f.write("=" * 60 + "\n\n")
