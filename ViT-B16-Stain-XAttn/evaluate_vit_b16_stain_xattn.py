# ============================================================
# ViT-B16-Stain-XAttn — Official Test Evaluation Script (CLI)
# ============================================================
#
# Loads the best Stage 2 checkpoint (best_stage2.pt — NEVER
# last.pt) and evaluates on the official test set exactly once.
#
# Rebuilds the SAME ViT-B16-Stain-XAttn architecture (ImageNet
# pretrained backbone + gated cross-attention stain pathway), then
# loads the saved training checkpoint.
#
...
from train_vit_b16_stain_xattn import get_test_transform
...
def setup_logging(log_dir: str) -> logging.Logger:
    logger = logging.getLogger("vit_b16_stain_xattn_eval")
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Evaluate ViT-B16-Stain-XAttn on Official Test Set")
...
def main() -> None:
    ...
    # Rebuild the ViT-B16-Stain-XAttn (same architecture) and load best_stage2.pt.
    ...
    print("=" * 60)
    print("ViT-B16-Stain-XAttn — Official Test Evaluation")
    print("=" * 60)
    ...
    with open(report_path, "w") as f:
        f.write("=" * 60 + "\n")
        f.write("ViT-B16-Stain-XAttn — Official Test Evaluation\n")
        f.write("=" * 60 + "\n\n")
