# ============================================================
# ViT-B16-Stain-XAttn — Precompute Global Stain Statistics
# ============================================================
#
...
# ViT-B16-Stain-XAttn/ (ViT-B16-Stain-XAttn/color_deconv.py)
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Precompute global H/DAB stain statistics (ViT-B16-Stain-XAttn)."
    )
    parser.add_argument(
        "--config",
        type=str,
        default="configs/vit_b16_stain_xattn_config.yaml",
        help="Path to the ViT-B16-Stain-XAttn config file.",
    )
